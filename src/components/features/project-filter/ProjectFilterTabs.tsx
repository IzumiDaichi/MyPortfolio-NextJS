...
import LazyProjectCard from "@/components/features/LazyProjectCard";
...
import styles from "./ProjectFilterTabs.module.css";
...
const TAB_ICONS: Record<Tab, React.ReactNode> = {
  ...
  Code: (
    ...
    >
      <path
        d="M4 4L1.5 7 4 10M10 4L12.5 7 10 10M8 2L6 12"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
...
// All projects included in the modal.
// These remain available even when cards are lazy-rendered.
      ...
      {filtered.length === 0 ? (
        ...
        <div className={styles.grid}>
          {filtered.map((project) => {
            const modalIndex = modalProjects.findIndex(
              (m) => m.title === project.title
            );
