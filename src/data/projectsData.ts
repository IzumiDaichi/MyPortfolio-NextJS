...
export const projects: Project[] = [
  ...
  {
    category: "Code",
    images: ["/Fastbreak.webp",],
    title: "Fastbreak Transaction Tracker",
    description:
      "The first project i made myself with the help of CLAUDE. This desktop application is designed to simplify storage business management. Track buying and selling transactions, monitor capital, analyze profits, and manage multiple storage terms (seasons or years). Generate detailed reports and keep your data securely synced across devices with real-time cloud synchronization.",
    tags: [
      "Next.js",
      "Electron",
      "Google Cloud API",
