...
import { AiOutlineClose, AiOutlineFacebook, AiOutlineGithub, AiOutlineMenu, AiOutlineX } from "react-icons/ai";
    ...
    <nav className="bg-slate-900 block fixed top-0 z-10 w-full shadow-xl">
      ...
      >
        ...
        <div className="flex flex-row justify-around pt-10 items-center">
          ...
          <AiOutlineFacebook size={50} color="white" className="cursor-pointer"/>
          </Link>
          ...
          <AiOutlineGithub size={50} color="white" className="cursor-pointer"/>
          </Link>
        </div>
      </div>
    </nav>
